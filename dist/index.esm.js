...
var Warning = function (_a) {
    ...
    return (React.createElement(FlexContainer, null,
        React.createElement(FlexMsg, null,
            React.createElement(Text, { bold: true, color: "primary" }, "PHISHING WARNING:"),
            React.createElement(Text, { color: "textSubtle", pl: "5px" }, "please make sure you are visiting"),
            React.createElement(Text, { bold: true, paddingX: "5px" }, "https://app.fanluan.finance"),
            React.createElement(Text, { color: "textSubtle" }, "- check the URL carefully.")),
