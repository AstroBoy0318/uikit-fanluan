...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", style: isMobile ? { height: "40px" } : { height: "40px", display: "none" } }, isPushed ? (React__default['default'].createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$K, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "AVATerra Home" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "AVATerra Home" }, innerLogo))));
};
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, { onMouseEnter: !isMobile ? handleClick : (function () { }), onMouseLeave: !isMobile ? handleClick : (function () { }) },
        React__default['default'].createElement(MenuEntry, { className: className, onClick: isMobile ? handleClick : (function () { }), isMobile: isMobile },
            icon,
            React__default['default'].createElement(LinkLabel, { isPushed: isPushed, isMobile: isMobile }, label),
            isOpen ? React__default['default'].createElement(Icon$8, null) : React__default['default'].createElement(Icon$7, null)),
        React__default['default'].createElement(AccordionContent, { isOpen: isOpen, isPushed: isPushed, maxHeight: React__default['default'].Children.count(children) * MENU_ENTRY_HEIGHT, top: MENU_HEIGHT, isMobile: isMobile }, children)));
};
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, { isMobile: isMobile }, links.map(function (entry) {
        var Icon = Icons[entry.icon];
        var iconElement = React__default['default'].createElement(Icon, { width: "24px", mr: "8px" });
        var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
        if (entry.items) {
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, isMobile: isMobile, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, isMobile: isMobile },
                    React__default['default'].createElement(MenuLink, { href: item.href }, item.label))); })));
        }
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass, isMobile: isMobile },
            React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                iconElement,
                React__default['default'].createElement(LinkLabel, { isPushed: isPushed, isMobile: isMobile }, entry.label))));
    })));
};
var templateObject_1$B;
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            ...
            React__default['default'].createElement(Flex, null, socials != null && socials.map(function (social, index) {
        ...
        React__default['default'].createElement(SettingsEntry, { style: { display: "none" } },
...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu, closedWarning: closedWarning },
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://ftmscan.com/address/" + account, mr: "16px" }, "View on FTM Explorer"),
...
var SocialEntry$1 = styled__default['default'].div(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"])), MENU_ENTRY_HEIGHT);
var PriceLink$1 = styled__default['default'].a(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
...
var UserBlock = function (_a) {
    ...
    var _c = React.useState(false), isPending = _c[0], setIsPending = _c[1];
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center" },
        ...
        cakePriceUsd ? (React__default['default'].createElement(PriceLink$1, { href: priceLink, target: "_blank" },
            ...
            React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })),
        cakeContract != null &&
            React__default['default'].createElement(Button, { onClick: addToken, disabled: isPending, ml: 10, mr: 10, size: "sm", padding: 0, style: { background: "transparent", border: "none" } },
                React__default['default'].createElement("img", { src: "/images/tokens/metamask.png", alt: "metamask", style: { width: "30px" } })),
...
var FlexContainer = styled__default['default'](Flex)(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n    disply: flex;\n    position: relative;\n    padding: 10px 0;\n    background: linear-gradient(rgb(128, 81, 214) 0%, rgb(73, 34, 134) 100%);\n    justify-content: center;\n"], ["\n    disply: flex;\n    position: relative;\n    padding: 10px 0;\n    background: linear-gradient(rgb(128, 81, 214) 0%, rgb(73, 34, 134) 100%);\n    justify-content: center;\n"])));
var FlexMsg = styled__default['default'](Flex)(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n    background: rgba(39, 38, 44, 0.4);\n    padding: 0 25px;\n    border-radius: 20px;\n    min-height: 60px;\n    align-items: center;\n    flex-wrap: wrap;\n    &>div{\n        white-space: nowrap;\n    }\n"], ["\n    background: rgba(39, 38, 44, 0.4);\n    padding: 0 25px;\n    border-radius: 20px;\n    min-height: 60px;\n    align-items: center;\n    flex-wrap: wrap;\n    &>div{\n        white-space: nowrap;\n    }\n"])));
var Warning = function (_a) {
    ...
    return (React__default['default'].createElement(FlexContainer, null,
        React__default['default'].createElement(FlexMsg, null,
            React__default['default'].createElement(Text, { bold: true, color: "primary" }, "PHISHING WARNING:"),
            React__default['default'].createElement(Text, { color: "textSubtle", pl: "5px" }, "please make sure you are visiting"),
            React__default['default'].createElement(Text, { bold: true, paddingX: "5px" }, "https://app.fanluan.finance"),
            React__default['default'].createElement(Text, { color: "textSubtle" }, "- check the URL carefully.")),
        React__default['default'].createElement(Button, { variant: "secondary", size: "sm", padding: 0, style: { border: "none", position: "absolute", top: "calc(50% - 16px)", right: "10px" }, onClick: handler },
...
var MenuContainer = styled__default['default'].div(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  top: ", ";\n  transition: top 0.3s;\n  left: 0;\n  z-index: 20;\n  width: 100%;\n"], ["\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  top: ", ";\n  transition: top 0.3s;\n  left: 0;\n  z-index: 20;\n  width: 100%;\n"])), function (_a) {
...
var Menu = function (_a) {
    ...
    var _f = React.useState(warningClosed), closedWarning = _f[0], setClosedWarning = _f[1];
    React.useEffect(function () {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(MenuContainer, { showMenu: showMenu },
            !closedWarning && React__default['default'].createElement(Warning, { setClosedWarning: setClosedWarning, toggleValue: toggleWarningClosed }),
            React__default['default'].createElement(StyledNav, { showMenu: showMenu },
                ...
                !isMobile &&
                    React__default['default'].createElement(PanelBody, { isPushed: isPushed, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, socials: socials }),
                !!login && !!logout && (React__default['default'].createElement(Flex, null,
                    React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, cakeContract: cakeContract, priceLink: priceLink, socials: socials, cakePriceUsd: cakePriceUsd }),
                    profile && React__default['default'].createElement(Avatar, { profile: profile }))))),
        React__default['default'].createElement(BodyWrapper, null,
            isMobile &&
                React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, closedWarning: closedWarning, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, socials: socials }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu }, children),
            React__default['default'].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" })),
        !isMobile &&
            React__default['default'].createElement(PanelFooter, { isPushed: isPushed, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, socials: socials })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#061740", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#3360a6", input: "#000000", tertiary: "#383940", text: "#FFFFFF", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", borderColor: "#E9EAEB", card: "#122146", gradients: {
